...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box;-webkit-tap-highlight-color:transparent}
    ...
    .scan-frame{overflow:hidden;border:3px solid rgba(var(--scan-color-rgb),.96);border-radius:10px;background:radial-gradient(circle at 0 0,#fff 0 4px,rgba(var(--scan-color-rgb),1) 4px 7px,transparent 8px),radial-gradient(circle at 100% 0,#fff 0 4px,rgba(var(--scan-color-rgb),1) 4px 7px,transparent 8px),radial-gradient(circle at 0 100%,#fff 0 4px,rgba(var(--scan-color-rgb),1) 4px 7px,transparent 8px),radial-gradient(circle at 100% 100%,#fff 0 4px,rgba(var(--scan-color-rgb),1) 4px 7px,transparent 8px),rgba(var(--scan-color-rgb),.08);box-shadow:0 0 0 1px rgba(255,255,255,.72),0 0 26px rgba(var(--scan-color-rgb),.48),inset 0 0 18px rgba(var(--scan-color-rgb),.16)}
...
#ps-scan-effect.scan-frame{overflow:hidden;border:3px solid rgba(var(--scan-color-rgb),.96);border-radius:10px;background:radial-gradient(circle at 0 0,#fff 0 4px,rgba(var(--scan-color-rgb),1) 4px 7px,transparent 8px),radial-gradient(circle at 100% 0,#fff 0 4px,rgba(var(--scan-color-rgb),1) 4px 7px,transparent 8px),radial-gradient(circle at 0 100%,#fff 0 4px,rgba(var(--scan-color-rgb),1) 4px 7px,transparent 8px),radial-gradient(circle at 100% 100%,#fff 0 4px,rgba(var(--scan-color-rgb),1) 4px 7px,transparent 8px),rgba(var(--scan-color-rgb),.08);box-shadow:0 0 0 1px rgba(255,255,255,.72),0 0 26px rgba(var(--scan-color-rgb),.48),inset 0 0 18px rgba(var(--scan-color-rgb),.16)}
#ps-scan-effect.scan-frame:before{content:"";position:absolute;left:8%;right:8%;top:-24%;height:22%;border-radius:999px;background:linear-gradient(180deg,transparent,rgba(255,255,255,.96),rgba(var(--scan-color-rgb),.58),transparent);box-shadow:0 0 24px rgba(var(--scan-color-rgb),.72);animation:psScanFrameBeam ${clamp(layer.scanSpeed, 400, 5000)}ms ease-in-out ${clamp(layer.scanDelay, 0, 3000)}ms ${scanIterations} ${scanDirection} both;animation-play-state:${layer.scanAutoplay ? 'running' : 'paused'}}
#ps-scan-effect.scan-frame:after{content:"";position:absolute;inset:10px;border:1px solid rgba(255,255,255,.54);border-radius:6px;box-shadow:inset 0 0 18px rgba(var(--scan-color-rgb),.22)}
